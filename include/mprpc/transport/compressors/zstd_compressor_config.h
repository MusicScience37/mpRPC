...
/*!
 * \brief configuration of compressors using zstd library
 */
struct zstd_compressor_config {
    //! compression level
    config::option<zstd_compression_level> compression_level{};
};
